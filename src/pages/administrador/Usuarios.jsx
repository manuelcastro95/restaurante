...
const Usuarios = () => {
    ...
    const url = 'https://restaurante-endpoints.vercel.app/v1/restaurante/users';
    ...
    const cargar_roles = async () => {
        ...
        const data = await fetch('https://restaurante-endpoints.vercel.app/v1/restaurante/roles')
            .then(res => res.json())
            .then(data => data)
        setRoles(data)
    }
